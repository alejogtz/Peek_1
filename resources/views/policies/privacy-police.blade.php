...
<body>
    ...
    <p>&nbsp;</p>
    <p>El presente Política de Privacidad establece los términos en que Peek usa y protege la información que es
    ...
    <p>Nuestro sitio web emplea la información con el fin de proporcionar el mejor servicio posible, particularmente para
        ...
        cualquier momento.</p>
    <p>Peek está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos los
    ...
    <p>Nuestro sitio web emplea las cookies para poder identificar las páginas que son visitadas y su frecuencia. Esta
        ...
        menos de que usted así lo quiera y la proporcione directamente, <a href="https://custommapposter.com/es/" target="_blank">visitas a una web </a>. Usted puede aceptar o negar el uso de cookies, sin embargo la mayoría de
    ...
    <p>Peek Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier momento.</p>
